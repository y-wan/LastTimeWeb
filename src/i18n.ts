...
const translations = {
  en: {
    ...
    icon: 'Icon', color: 'Color', eventDetails: 'Event details', occurrences: 'History',
    ...
    emptyTitle: 'Nothing here yet', empty: 'Add an event to remember when it last happened.', noHistory: 'Never recorded',
  ...
  'zh-CN': {
    ...
    emptyTitle: '还没有事件', empty: '添加一个事件，记住它上次发生的时间。', noHistory: '尚未记录',
